package com.template.config.mybatis.plus;
...
public class CodeGenerator {
     ...
     * 数据库链接地址
     */
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/exam_0591?useUnicode=true&useSSL=false&characterEncoding=utf8";
     ...
     * 作者
     */
    private static final String AUTHOR = "zkl";

    /**
     * 父包名
     */
    private static final String PACKAGE_PARENT = "com.template";
    ...
    public static void main(String[] args) {
        // 执行
        getAutoGenerator("test_crime").execute();
    }
